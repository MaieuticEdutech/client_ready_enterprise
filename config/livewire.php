...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Films are large. The 12MB default is far too small, so the cap is
        // raised here and enforced per-field in the upload components too.
        'rules' => ['required', 'file', 'max:'.env('LIVEWIRE_UPLOAD_MAX_KB', 2097152)], // 2GB
